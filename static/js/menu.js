$('.menu-button-container').on('click', function() {
    ...
    if ($(this).hasClass('closed')) {
        ...
        gsap.to(".page-container", 0.8, { 'transform': 'translateX(-50vw)', ease: 'power3' })
        gsap.to(".fixed-top-menu", 0.8, { 'transform': 'translateX(-50vw)', ease: 'power3' })
        gsap.from(".menu-mobile-items li", 0.5, { stagger: 0.2, 'transform': 'translateX(50vw)' })
        tl.to('.rectangle', 0.5, { stagger: 0.1, 'transform': 'scaleX(0)', ease: 'power1' })
        ...
        gsap.to(".page-container", 0.5, { 'transform': 'translateX(0vw)' })
